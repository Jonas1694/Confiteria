...
namespace ArquitecturaModel.Migrations
{
    ...
    [Migration("20250922171725_UpdateDetalleDevolucion_Sucursal")]
    partial class UpdateDetalleDevolucion_Sucursal
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArquitecturaModel.Model.DetalleDevolucion", b =>
                {
            ...
            modelBuilder.Entity("ArquitecturaModel.Model.Devolucion", b =>
                {
                    ...
                    b.Property<string>("DescripcionDevolucion")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ArquitecturaModel.Model.Inventario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArquitecturaModel.Model.StatusDocumentos", b =>
                {
                    b.Property<int>("StatusDocumentoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("StatusDocumentoId"));

                    b.Property<string>("StatusDocumento")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("StatusDocumentoId");

                    b.ToTable("StatusDocumentos");
                });

            modelBuilder.Entity("ArquitecturaModel.Model.Sucursales", b =>
                {
                    ...
                    b.HasIndex("SucursalName")
                        .IsUnique();

                    b.ToTable("Sucursales");
                });

            modelBuilder.Entity("ArquitecturaModel.Model.TasaDolar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArquitecturaModel.Model.DetalleDevolucion", b =>
                {
                    b.HasOne("ArquitecturaModel.Model.Devolucion", "Devolucion")
                        .WithMany()
            ...
            modelBuilder.Entity("ArquitecturaModel.Model.Devolucion", b =>
                {
                    ...
                    b.HasOne("ArquitecturaModel.Model.StatusDocumentos", "StatusDocumento")
                        .WithMany()
                        .HasForeignKey("StatusDocumentoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ArquitecturaModel.Model.Facturacion", b =>
                {
                    ...
                    b.HasOne("ArquitecturaModel.Model.TasaDolar", "TasaDolar")
                        .WithMany()
                        .HasForeignKey("TasaDolarId");
